...
import com.qboxus.tictic.activitesfragments.videorecording.ActVideoTrimmer;
...
public class TrimVideo {
    ...
    public static String getTrimmedVideoPath(Intent intent,String path){
    ...
    public static final class ActivityBuilder {
        ...
        int recordingDuration=15000;
        public ActivityBuilder setMaxTimeCheck(@NonNull int recordingDuration) {
        ...
        private Intent getIntent(Activity activity) {
            ...
            bundle.putInt("recordingDuration",recordingDuration);
