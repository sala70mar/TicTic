...
public class UserModel implements Serializable {
    ...
    String id,firstName,lastName,gender,bio,website,dob,social_id,email,phone,password,profilePic,profileGif,role,username,socialType
            ,deviceToken,token,active,online,verified,applyVerification,referalCode,authToken,version,device,ip,city,country,cityId,stateId,countryId
