...
public class MultipleAccountModel implements Serializable {
    ...
    String id,fName,lName,uName,uBio,uLink,gender,uPic,uGif,uWallet,uPayoutId,authToken,phoneNo,email,socialId
            ,verified,applyVerification,profileView,referalCode;
    ...
    public String getuGif() {
        return uGif;
    }

    public void setuGif(String uGif) {
        this.uGif = uGif;
    }
