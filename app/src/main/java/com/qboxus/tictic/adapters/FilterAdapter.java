...
import com.qboxus.tictic.simpleclasses.FilterType;
import com.qboxus.tictic.R;
import com.qboxus.tictic.activitesfragments.videorecording.PreviewVideoA;
...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.CustomViewHolder> {
    ...
    public FilterAdapter(Context context, List<FilterType> arrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        if (PreviewVideoA.selectPostion == i) {
            holder.ivPhoto.setBackgroundColor(context.getResources().getColor(R.color.appColor));
        }
