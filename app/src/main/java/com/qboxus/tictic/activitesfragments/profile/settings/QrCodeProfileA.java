...
import com.qboxus.tictic.activitesfragments.profile.ShareItemViaIntentA;
import com.qboxus.tictic.Constants;
import com.qboxus.tictic.interfaces.ShareIntentCallback;
import com.qboxus.tictic.R;
import com.qboxus.tictic.simpleclasses.Functions;
import com.qboxus.tictic.simpleclasses.ImageSaver;
...
public class QrCodeProfileA extends AppCompatLocaleActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inItControl();
        String profielLink = Variables.https+"://"+getString(R.string.share_profile_domain_second)+getString(R.string.share_profile_endpoint_second) + Functions.getSharedPreference(QrCodeProfileA.this).getString(Variables.U_ID,"");
