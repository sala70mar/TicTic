...
public class SubmitReportA extends AppCompatLocaleActivity implements View.OnClickListener {
    ...
    String reportId, txtReportType, videoId, userId,roomId;
    ...
    public void callApiReportRoom() {
        ...
        Functions.showLoader(SubmitReportA.this, false, false);
        VolleyRequest.JsonPostRequest(SubmitReportA.this, ApiLinks.reportRoom, params,Functions.getHeaders(this), new Callback() {
            @Override
            public void onResponce(String resp) {
                Functions.cancelLoader();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.submit_btn:
               ...
               else if(roomId!=null && checkValidation())
                    callApiReportRoom();
