...
public class FollowerUserF extends Fragment {
    ...
    public FollowerUserF(String userId, boolean isSelf,FragmentCallBack callBack)
    {
        this.userId=userId;
        this.isSelf=isSelf;
    ...
    public static FollowerUserF newInstance(String userId, boolean isSelf,FragmentCallBack callBack) {
        FollowerUserF fragment = new FollowerUserF(userId,isSelf,callBack);
