 ...
 */
public class SearchSoundF extends Fragment implements Player.Listener {
    ...
    public static SearchSoundF newInstance(String type) {
        SearchSoundF fragment = new SearchSoundF(type);
