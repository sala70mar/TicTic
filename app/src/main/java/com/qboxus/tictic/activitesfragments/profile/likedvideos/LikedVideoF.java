package com.qboxus.tictic.activitesfragments.profile.likedvideos;
...
public class LikedVideoF extends Fragment {
    ...
    public static LikedVideoF newInstance(boolean isMyProfile, String userId, String userName, boolean isLikeVideoShow,String isUserAlreadyBlock) {
        LikedVideoF fragment = new LikedVideoF(isMyProfile,userId, userName,isLikeVideoShow,isUserAlreadyBlock);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new MyVideosAdapter(context, dataList,"liked", new AdapterClickListener() {
            @Override
    ...
    private void setNoData() {
        if (isMyProfile)
        {
            ...
            tvMessageNoData.setText(Html.fromHtml(view.getContext().getString(R.string.you_can_change_this_in)+ "  <font color='#B7332F'> "+view.getContext().getString(R.string.privacy_setting)+" </font>",Html.FROM_HTML_MODE_LEGACY));
