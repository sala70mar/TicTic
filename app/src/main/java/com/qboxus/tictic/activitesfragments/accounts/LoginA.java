...
public class LoginA extends AppCompatLocaleActivity implements View.OnClickListener {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            GraphRequest request = GraphRequest.newMeRequest(token, new GraphRequest.GraphJSONObjectCallback() {
                                ...
                                public void onCompleted(JSONObject user, GraphResponse graphResponse) {
                                    ...
                                    String image = "https://graph.facebook.com/"+ finalId +"/picture?width=500";
                                    ...
                                    userRegisterModel.socailId = finalId;
                                    ...
                                    {
                                        userRegisterModel.referalCode=getIntent().getStringExtra("referalCode");
                                    }
                                    callApiForLogin("" + finalId,
                                            "facebook",
                                            auth_token,email);
    ...
    private void callApiForLogin(String socialId, String social, final String authtoken,String email) {
