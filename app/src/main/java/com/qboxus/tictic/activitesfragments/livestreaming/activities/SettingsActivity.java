...
import static com.qboxus.tictic.activitesfragments.livestreaming.Constants.PREF_RESOLUTION_IDX;
...
import com.qboxus.tictic.activitesfragments.livestreaming.ui.ResolutionAdapter;
...
// live streaming camera setting screen
public class SettingsActivity extends BaseActivity {
    private static final int DEFAULT_SPAN = 3;

    private TextView  mMirrorLocalText, mMirrorRemoteText, mMirrorEncodeText;
    ImageView mVideoStatCheck;
