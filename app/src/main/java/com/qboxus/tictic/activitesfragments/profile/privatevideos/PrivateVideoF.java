package com.qboxus.tictic.activitesfragments.profile.privatevideos;
...
public class PrivateVideoF extends Fragment {
    ...
    public static PrivateVideoF newInstance() {
        PrivateVideoF fragment = new PrivateVideoF();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new MyVideosAdapter(context, dataList,"private", new AdapterClickListener() {
            @Override
