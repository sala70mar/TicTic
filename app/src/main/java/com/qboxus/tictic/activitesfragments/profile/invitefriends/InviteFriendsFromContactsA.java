package com.qboxus.tictic.activitesfragments.profile.invitefriends;
...
import com.qboxus.tictic.adapters.InviteFriendAdapter;
...
import com.qboxus.tictic.models.InviteFriendModel;
...
public class InviteFriendsFromContactsA extends AppCompatLocaleActivity implements View.OnClickListener {
    ...
    public void shareProfile(ShareAppModel item) {
        String profielLink = Variables.https+"://"+getString(R.string.share_profile_domain_second)+getString(R.string.share_profile_endpoint_second) + Functions.getSharedPreference(InviteFriendsFromContactsA.this).getString(Variables.U_ID,"");
