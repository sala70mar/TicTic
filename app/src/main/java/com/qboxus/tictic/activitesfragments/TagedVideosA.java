...
public class TagedVideosA extends AppCompatLocaleActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyVideosAdapter(context, dataList,"tagged", new AdapterClickListener() {
            @Override
        ...
        try {
            ...
            if (code.equals("200")) {
                ...
                if (favourite != null && favourite.equalsIgnoreCase("1")) {
                    favBtn.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.ic_fav_fill));
                    favTxt.setText(getString(R.string.added_to_favourite));
                } else {
                    favBtn.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.ic_fav));
    ...
    public void callApiFavHashtag() {
        ...
        Functions.showLoader(TagedVideosA.this, false, false);
