package com.qboxus.tictic.activitesfragments.profile.favourite;
...
import com.qboxus.tictic.adapters.VideosListAdapter;
...
public class FavouriteVideosF extends Fragment {
    ...
    public static FavouriteVideosF newInstance() {
        FavouriteVideosF fragment = new FavouriteVideosF();
