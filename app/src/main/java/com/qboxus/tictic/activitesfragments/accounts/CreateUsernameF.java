...
public class CreateUsernameF extends Fragment {
    View view;
    EditText usernameEdit,referal_edit;
    Button signUpBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        referal_edit=view.findViewById(R.id.referal_edit);
        ...
        try {
            ...
            {
                referal_edit.setText(""+userRegisterModel.referalCode);
            }
        }catch (Exception e)
        {
    ...
    private void call_api_for_sigup() {
        ...
        try {
            ...
            parameters.put("referral_code",referal_edit.getText().toString());
