package com.qboxus.tictic.activitesfragments.spaces.voicecallmodule.openacall.model;
...
public class MyEngineEventHandler {
    ...
    final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onUserOffline(int uid, int reason) {
            Functions.printLog(Constants.tag,"onUserOffline " + (uid & 0xFFFFFFFFL) + " " + reason);
        ...
        public void onLastmileQuality(int quality) {
            Functions.printLog(Constants.tag,"onLastmileQuality " + quality);
        }
        ...
        public void onError(int error) {
            Functions.printLog(Constants.tag,"onError " + error);
        ...
        public void onConnectionLost() {
            Functions.printLog(Constants.tag,"onConnectionLost");
        ...
        public void onConnectionInterrupted() {
            Functions.printLog(Constants.tag,"onConnectionInterrupted");
        ...
        public void onJoinChannelSuccess(String channel, int uid, int elapsed) {
            Functions.printLog(Constants.tag,"onJoinChannelSuccess " + channel + " " + (uid & 0xFFFFFFFFL) + " " + elapsed);
        ...
        public void onRejoinChannelSuccess(String channel, int uid, int elapsed) {
            Functions.printLog(Constants.tag,"onRejoinChannelSuccess " + channel + " " + (uid & 0xFFFFFFFFL) + " " + elapsed);
        }
        ...
        public void onWarning(int warn) {
            Functions.printLog(Constants.tag,"onWarning " + warn);
        }
        ...
        public void onAudioRouteChanged(int routing) {
            Functions.printLog(Constants.tag,"onAudioRouteChanged " + routing);
