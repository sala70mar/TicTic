...
public class StreamingChatA extends StreamingBaseA implements AGEventHandler {
    ...
    protected void initUIandEvent() {
        ...
        String channelName = i.getStringExtra(Variables.ACTION_KEY_CHANNEL_NAME);
    ...
    public void onSwitchSpeakerClicked(View view) {
        Functions.printLog(Constants.tag,"onSwitchSpeakerClicked " + view + " " + mAudioMuted + " " + mAudioRouting);
    ...
    public void onEndCallClicked(View view) {
        Functions.printLog(Constants.tag,"onEndCallClicked " + view);
    ...
    public void onBackPressed() {
        ...
        Functions.printLog(Constants.tag,"onBackPressed");

        quitCall();
    }

    private void quitCall() {
        Intent intent = new Intent(this, StreamingA.class);
    ...
    public void onVoiceMuteClicked(View view) {
        Functions.printLog(Constants.tag,"onVoiceMuteClicked " + view + " audio_status: " + mAudioMuted);
        ...
        if (mAudioMuted) {
            iv.setColorFilter(getResources().getColor(R.color.appColor), PorterDuff.Mode.MULTIPLY);
        } else {
            iv.clearColorFilter();
        }
    }
            ...
            case AGEventHandler.EVENT_TYPE_ON_SPEAKER_STATS: {
                ...
                if (volumeCache.length() > 0) {
                    ...
                    if ((System.currentTimeMillis() / 1000) % 10 == 0) {
                        Functions.printLog(Constants.tag,volumeMsg);
                    }
                }
                break;
            }
