...
public class ShareItemViaIntentA extends BottomSheetDialogFragment implements View.OnClickListener  {
    ...
    public void shareProfile(ShareAppModel item) {
        ...
        String profielLink = Variables.https+"://"+getString(R.string.share_profile_domain_second)+getString(R.string.share_profile_endpoint_second) + Functions.getSharedPreference(getActivity()).getString(Variables.U_ID,"");
