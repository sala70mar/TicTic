...
import com.qboxus.tictic.activitesfragments.profile.SendDirectMsg;
import com.qboxus.tictic.activitesfragments.profile.analytics.VideoAnalytics;
import com.qboxus.tictic.adapters.FollowingShareAdapter;
...
public class VideoActionF extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ivPinned=view.findViewById(R.id.ivPinned);
        ...
        view.findViewById(R.id.repost_layout).setOnClickListener(this);
        view.findViewById(R.id.analytic_layout).setOnClickListener(this);
        ivRepost=view.findViewById(R.id.ivRepost);

        if (item.pin.equals("1"))
        {
            ivPinned.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.ic_pinned_selected));
            tvPinned.setText(context.getString(R.string.unpin));
        }
        else
        {
            ivPinned.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.ic_pinned_unselected));
            tvPinned.setText(context.getString(R.string.pin));
        }
        ...
        if (userId != null && userId.equals(Functions.getSharedPreference(context).getString(Variables.U_ID, ""))) {
            ...
            view.findViewById(R.id.pinned_layout).setVisibility(View.VISIBLE);
            view.findViewById(R.id.analytic_layout).setVisibility(View.VISIBLE);
            view.findViewById(R.id.promotion_layout).setVisibility(View.VISIBLE);
        } else {
            ...
            view.findViewById(R.id.pinned_layout).setVisibility(View.GONE);
            view.findViewById(R.id.analytic_layout).setVisibility(View.GONE);
            view.findViewById(R.id.promotion_layout).setVisibility(View.GONE);
        }
        ...
        {
            ivRepost.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.ic_repost_done));
        }
        else
        {
            ivRepost.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.ic_repost));
        }
        ...
        view.findViewById(R.id.pinned_layout).setOnClickListener(this);
        view.findViewById(R.id.promotion_layout).setOnClickListener(this);
        view.findViewById(R.id.add_favourite_layout).setOnClickListener(this);
        view.findViewById(R.id.not_intrested_layout).setOnClickListener(this);
    ...
    private boolean isShowVideoDownloadPrivacy(HomeModel home_item) {
        if (home_item.apply_privacy_model != null && home_item.apply_privacy_model.getVideos_download().equalsIgnoreCase("0"))
            return false;
        else
            return true;
    }
    ...
    public void clickedUsers(int postion){
        ...
        if(selectedUserList.size()>0){
            ...
            bottomBtn.setBackground(ContextCompat.getDrawable(view.getContext(),R.color.appColor));
            bottomBtn.setTextColor(ContextCompat.getColor(view.getContext(),R.color.whiteColor));
        }
        else {
            bottomBtn.setTextColor(ContextCompat.getColor(view.getContext(),R.color.darkgray));
    ...
    public void sendvideo(FollowingModel followerItem) {
        ...
        message_user_map.put("pic_url", item.getThum());
        ...
        rootref.updateChildren(user_map, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                ...
                receivermap.put("pic", followerItem.getProfile_pic());
    ...
    public void shareProfile(ShareAppModel item) {
        if ( getActivity()!=null && !(item.getName().equalsIgnoreCase(view.getContext().getString(R.string.copy_link))))
        {
            getActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
    ...
    public void sendShareVideo(String videoId){
        ...
        VolleyRequest.JsonPostRequest(getActivity(), ApiLinks.shareVideo, parameters,Functions.getHeaders(context), new Callback() {
            @Override
            public void onResponce(String resp) {
                Functions.checkStatus(getActivity(),resp);
                try {
