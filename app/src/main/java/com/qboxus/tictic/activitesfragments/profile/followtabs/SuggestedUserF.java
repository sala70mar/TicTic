package com.qboxus.tictic.activitesfragments.profile.followtabs;
...
import com.qboxus.tictic.activitesfragments.profile.videopromotion.VideoPromoteVideosF;
...
public class SuggestedUserF extends Fragment {
    ...
    public SuggestedUserF(String userId, boolean isSelf,FragmentCallBack callBack)
    {
        this.userId=userId;
        this.isSelf=isSelf;
    ...
    public static SuggestedUserF newInstance(String userId, boolean isSelf, FragmentCallBack callBack) {
        SuggestedUserF fragment = new SuggestedUserF(userId,isSelf,callBack);
